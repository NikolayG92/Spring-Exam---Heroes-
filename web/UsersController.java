...
import heroesproject.demo.models.binding.UserLoginBindingModel;
import heroesproject.demo.models.binding.UserRegisterBindingModel;
...
import heroesproject.demo.service.UserService;
...
public class UsersController {
    ...
    public UsersController(UserService userService, ModelMapper modelMapper, UserRepository userRepository) {
    ...
    @PostMapping("/login")
    private String loginConfirm(@Valid @ModelAttribute("userLoginBindingModel")
        ...
        if(bindingResult.hasErrors()){
            ...
            redirectAttributes.addFlashAttribute("org.hibernate.validation.BindingResult.UserLoginBindingModel", bindingResult);
